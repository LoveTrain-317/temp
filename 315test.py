...
line_as2, = ax_as.plot([], [], 'g-', lw=2, label='Device2 As')
...
ax_acc.grid(True)
line_acc1, = ax_acc.plot([], [], 'b-', lw=2, label='Device1 Acc')
line_acc2, = ax_acc.plot([], [], 'm-', lw=2, label='Device2 Acc')
...
text_acc2 = ax_acc.text(1.02, 0.3, "", transform=ax_acc.transAxes,
                        color='magenta', ha='left', va='center', fontsize=12)
